...
01_hosts_survey <img src="man/figures/compendium-sticker.png" align="right" style="float:right; height:120px;"/>
=========================================================
...
Launch the [`make.R`](https://github.com/aoberard/01_hosts_survey/tree/main/make.R)
file with:
...
check out our [Contributor Guidelines](https://github.com/aoberard/01_hosts_survey/blob/main/CONTRIBUTING.md).
